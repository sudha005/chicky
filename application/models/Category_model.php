...
class Category_model extends CI_Model {
	...
	var $column_order = array(null, 'category_code','category_name','description','cat_image','status'); //set column field database for datatable orderable
	...
	public function update_category(){
		...
		if($query->num_rows()>0){
			...
			$query1="update db_category set category_name='$category',description='$description' $cat_image where id=$q_id";
			if ($this->db->simple_query($query1)){
