...
class Pos extends MY_Controller {
	...
	public function get_last_invoice(){
        ...
        if(isset($id)) {
        $id_invoice =$id;
        $url_invoice=base_url()."pos/print_invoice_pos/".$id_invoice;
        } else {
        $url_invoice="#";
        }  
        return $url_invoice;
	 ...
	 public function pos_save_update_vendor(){
    $result='';
    if($this->input->post('command')=='update'){//Update
    	$result = $this->pos_model->pos_save_update_vendor();
    }
    else{//Save
    	$result = $this->pos_model->pos_save_update_vendor();
        $result =$result."<<<###>>>".$this->pos_model->get_details();
	...
	public function get_details_quick(){
		echo $this->pos_model->get_details_quick();
	}
	//get_details_modifier
	public function get_details_modifier(){
		echo $this->pos_model->get_details_modifier();
	}
    
    public function print_invoice_pos_notification(){
