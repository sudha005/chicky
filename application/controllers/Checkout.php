                ...
                <table  align="center" border="0" cellpadding="0" cellspacing="0" width="800" style="border: 1px solid #cccccc;background-color:#8ec400;padding:10px;">
                    <tr bgcolor="#fff">
                        <td align="center"  style="color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                            <img width="120px" src="http://cygendev.com/dev/chicky/assets/images/logo.png" alt="Chickycharchar"  style="display: block;" />
                        </td>
                    </tr>
...
public function ordersuccess(){
  ...
  // $this->thankyou();
	...
	//$name = "Your Chickycharchar order confirmation ( '.$order_id.' )";
...
//	$user_mobile = $getUserDetails['user_mobile'];
	...
	//	$message2 = 'Order Placed by '.$getUserDetails['user_full_name'].'  mobile number '.$getUserDetails['user_mobile'].' and the order id is <a href="http://Chickycharchar.com.au/grocery_admin">'.$order_id.'</a>.'; // Message text required to deliver on mobile number
	//  $sendSMS = sendMobileSMS($message2,$user_mobile1);
	   //Sending SMS after placing Order to My Servant
	  
	 //  $user_mobile2 = '61458116301';
	  //  $message3 = 'Order Placed by '.$getUserDetails['user_full_name'].'  mobile number '.$getUserDetails['user_mobile'].' and the order ID is <a href="http://Chickycharchar.com.au/grocery_admin">'.$order_id.'</a>.'; // Message text required to deliver on mobile number
