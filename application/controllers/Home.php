...
//   $getSiteSettingsData1 = $getSiteSettings1->fetch_assoc();
    ...
    $mobile_otp = "1234";
    $message = ('OTP from Chickycharchar is '.$mobile_otp.' . Do not share it with any one.'); // Message text required to deliver on mobile number
                ...
                <table  align="center" border="0" cellpadding="0" cellspacing="0" width="800" style="border: 1px solid #cccccc;background-color:#f52f2c;padding:10px;">
                    <tr bgcolor="#fff">
                        <td align="center"  style="color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                            <img width="150px" src="http://cygendev.com/dev/chicky/assets/images/logo.png" alt="Chickycharchar"  style="display: block;" />
                        </td>
                    </tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;" width="90%">
                                                    In case you need any assistance please do not hesitate to call our customer service on +63 12345678 07:00 am to 10:00 pm on all days or email us at admin@Chickycharchar.com.au 
                                                        ...
                                                        <tr>
                                                            <td style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
                                                                <a href="http://www.twitter.com/" style="color: #ffffff;">
                                                                    <img src="http://cygenpos.com.au/dev/Chickycharchar/assets/images/fb.png" alt="Twitter" width="38" height="38" style="display: block;" border="0" />
                                                                </a>
                                                            </td>
                                                            <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
                                                            <td style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
                                                                <a href="http://www.twitter.com/" style="color: #ffffff;">
                                                                    <img src="http://cygenpos.com.au/dev/Chickycharchar/assets/images/tw.png" alt="Facebook" width="38" height="38" style="display: block;" border="0" />
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
...
public function check_otp(){
	...
	//	saveAdminLogs('3',$_SESSION['user_login_session_id'],$message);//3- for grocery_cart
		...
		$to = $dataem;
		$subject = "Welcome to Chickycharchar";
		$message = '';		
...
<body style="margin: 0; padding: 0;">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" > 
        <tr>
            <td style="padding:10px;" >
                <table  align="center" border="0" cellpadding="0" cellspacing="0" width="800" style="border: 1px solid #cccccc;background-color:#f52f2c;padding:10px;">
                    <tr bgcolor="#fff">
                        <td align="center"  style="color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                            <img width="120px" src="http://cygenpos.com.au/dev/Chickycharchar/assets/images/menu/logo/4.jpg" alt="Chickycharchar"  style="display: block;" />
                        </td>
                    </tr>
						...
						<tr style="min-height:500px;" bgcolor="#ededed"><td colspan="3">
									  ...
									  <h1 style="color:#66aa44">Welcome To Chickycharchar</h1>
									  <p>A very special welcome to you <span style="color:#66aa44;">'.$getLoggedInDetails["customer_name"].'</span>, Thank you for joining Chickycharchar.com.au!</p>
										<p>Your pasword is <span style="color:#66aa44;">'.$user_password.'</span></p>
										<p>Please keep it secret, keep it safe!</p>
										<p>We hope you enjoy your stay at Chickycharchar.com.au, if you have any problems, questions, opinions, praise, comments, suggestions, please free to contact us at any time.</p>
										<p>Warm Regards,<br>The Chickycharchar Team </p>
									</article> 
						</td>			
						<tr>			
                                <tr>
                                    <td bgcolor="#764c28" style="padding: 30px 30px 30px 30px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;" width="90%">
                                                    In case you need any assistance please do not hesitate to call our customer service on +63 12345678 07:00 am to 10:00 pm on all days or email us at customerservice@Chickycharchar.com.au 
                                                    All calls to our customer support number will be recorded for internal training and quality purposes.
                                                </td>
                                                <td align="right" width="10%">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
                                                                <a href="http://www.twitter.com/" style="color: #ffffff;">
                                                                    <img src="http://Chickycharchar.com.au/images/fb.png" alt="Twitter" width="38" height="38" style="display: block;" border="0" />
                                                                </a>
                                                            </td>
                                                            <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
                                                            <td style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
                                                                <a href="http://www.twitter.com/" style="color: #ffffff;">
                                                                    <img src="http://Chickycharchar.com.au/images/tw.png" alt="Facebook" width="38" height="38" style="display: block;" border="0" />
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
		...
		$message1 =('Registration completed successfully.A very special welcome to you '.$getLoggedInDetails["customer_name"].', Thank you for joining Chickycharchar.com.au! Your pasword is '.$user_password.''); // Message text required to deliver on mobile number
...
// echo "no result";
    ...
    if($getUserForgotPassword = $getUserForgotData->row_array()) {
        ...
        $subject =  "Chickycharchar  -  Forgot Password";
        $message = '';
        $message .= '<body>
			...
			<header style="padding:0.8em;color: white;background-color: #f52f2c;clear: left;text-align: center;">
			 <center>Chickycharchar </center>
			</header>
			<article style=" border-left: 1px solid gray;overflow: hidden;text-align:justify; word-spacing:0.1px;line-height:25px;padding:15px">
			  <h1 style="color:#f7a201">Password Recovery From Chickycharchar</h1>
			...
			<footer style="padding: 1em;color: white;background-color: #f52f2c;clear: left;text-align: center;">All rights reserved @ Chickycharchar 2020.</footer>
			</div>
