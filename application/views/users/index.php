            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 form-group">
                        <img src="assets/images/about-us-chicky.jpg" class="img-fluid mb--m4" />
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center form-group">
                        <h4>Delicated</h4>
                        <h2>What CHICKY OFFERS</h2>
                        <img src="assets/images/flower-decor.png" class="heading-decor" />
                        <p>In these unusual times where the world has gone upside down, Chicky char char offers contactless Tabletop Ordering, take away and Online delivery services to make sure our customers as well as our work staff are Covid-19 safe and enjoying their routine of life without any hindrance, thanks to our IT consulting support- CYGEN..!!</p>
            ...
            <div class="container-fluid lineargreadient-bg p-0 ">
                <div class="row h-100 align-items-center m-0">
                    <div class="col-md-6 pl-0">
                        <img src="assets/images/party.jpg" class="img-fluid" />
                    </div>   
                    <div class="col-md-6">
