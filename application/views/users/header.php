...
<head>
       <title>ChickyCharChar</title>
        <meta charset="utf-8">
        <meta name="theme-color" content="#f52f2c" />
    ...
    margin-right: 0rem;
        ...
        <div id="loader">
            <div class="loading-inside">
                ...
                <img src="assets/images/logo-loader.png" class="img-fluid gray loader-img" />
                <h4 class="loader-text">Tasty Menu is loading....</h4>
