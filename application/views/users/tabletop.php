...
<html lang="en">
<head>
       <title>Chickycharchar</title>
        <meta charset="utf-8">
        <meta name="theme-color" content="#8ec400" />
...
<div class="container">
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content">
        <div class="bg-sep"> <h3>COVID 19 Compliance Form</h3> <p class="basic-info">Please fill the form to follow by COVID guidelines.</p></div>
         <div class="bg-sep" style="background-color:#000"> <img src="https://chickycharchar.com.au/assets/images/logo.png" class="img-fluid table-modal-logo" /></div>
...
.bg-sep{
    ...
    text-align: center;
        margin-bottom: 10px;
        border-left: 3px solid #9bc72d;
    border-right: 3px solid #9bc72d;
}
.modal-content{
     padding: 0 0.75rem;
