...
<div id="myModalselect_delivery" class="modal fade" role="dialog">
  ...
  <section class="footer">
        ...
        <p class="footer-p">© 2020 - All Rights with Chickycharchar </p>
...
.button_view_more{
    background-color:#f52f2c!important;
    border:1px solid #f52f2c!important;
}
.cart-sucess,.cart-failure{
   z-index: 1060;
    ...
    color:#fff;
    width: 100%;
     background: #b3d294 none repeat scroll 0 0 !important;
}
.bg-success {
...
.min-cart-sidebar-body-top::-webkit-scrollbar,#display .productDv::-webkit-scrollbar  {
  width: 0.5em;
}
 
.min-cart-sidebar-body-top::-webkit-scrollbar-track,#display .productDv::-webkit-scrollbar-track {
  box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
}
 
.min-cart-sidebar-body-top::-webkit-scrollbar-thumb ,#display .productDv::-webkit-scrollbar-thumb{
  background-color: darkgrey;
  outline: 1px solid slategrey;
}

.header-advance-search .button2 {
...
.min-cart-sidebar-footer-top .btn {f.cart-list-product p
}
...
.login-footer-tab .nav-tabs .nav-item {
    margin-bottom: 0px;
    width: 50%;
    font-family: 'Montserrat', sans-serif;
    font-weight: 600;
}
.login-footer-tab  .nav-tabs {
    border-bottom: none;
    background: #eee;
}
.search-control{
...
.login-footer-tab .nav-tabs .nav-link.active {
    color: #fff;
    background-color: #f52f2c;
    border-color: #f52f2c;
}
.login-footer-tab .nav-tabs .nav-link{
    font-size: 0.9rem;
    background: #000;
    border-radius: 0px;
...
.min-cart-sidebar-footer-top .btn-secondary{
       background-color: #f52f2c !important;
    border-color: #f52f2c !important;
    border-radius: 0px;
    font-weight: 500;
...
.cartsidebar-categories_menu ul li > a {
    display: block;
