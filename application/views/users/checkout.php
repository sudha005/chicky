                              ...
                              <div class="cart-sidebar-footer" style="padding: 10px;">
                                    <div class="cart-store-details">
            	                         ...
            	                         //   $getAllPaymentsSettings = getIndividualDetails('grocery_payments_settings','id','1');
                                          ...
                                          ?>
                                          <h6>Grand Total <strong class="float-right text-danger grandTotal">$<?php echo number_format($cartTotal +$delivery_charges+$service_tax+$addonaall,2);?></strong></h6>
                                    </div>
                                    ...
                                    <?php
                                     ...
                                     if($this->session->userdata('select_order_type')==2){
                                    ?>
                                    <button class="btn btn-secondary btn-lg btn-block text-left checkout_btn" type="submit"  <?php if($getCustomerAddress->num_rows == 0) { ?> disabled="" <?php } else { ?>  <?php } ?> ><span class="float-left"><i class="mdi mdi-cart-outline"></i> Proceed to Checkout </span><span class="float-right"><strong class="grandTotal">$<?php echo number_format($cartTotal +$delivery_charges+$service_tax+$addonaall,2);?></strong> <span class="mdi mdi-chevron-right"></span></span></button>
                                    <?php
                                     }else{
                                           ?>
                                    <button class="btn btn-secondary btn-lg btn-block text-left checkout_btn" type="submit"  ><span class="float-left"><i class="mdi mdi-cart-outline"></i> Proceed to Checkout </span><span class="float-right"><strong class="grandTotal">$<?php echo number_format($cartTotal +$delivery_charges+$service_tax+$addonaall,2);?></strong> <span class="mdi mdi-chevron-right"></span></span></button>       
                                           <?php
                                     }
                                    ?>
                              </div>
